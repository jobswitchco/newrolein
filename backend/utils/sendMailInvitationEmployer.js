  ...
  html: `
    <div style="font-family: Arial, sans-serif; color: #111; padding: 20px;">
      ...
      <div style="max-width: 600px; margin: 0 auto;">
        <h3 style="color: #222;">You've Received a New Job Invitation!</h3>

        <p style="font-size: 16px; line-height: 1.6;">
          Congratulations, a verified employer has invited you to explore a potential job switch opportunity on <strong>Newrole.in</strong>. 

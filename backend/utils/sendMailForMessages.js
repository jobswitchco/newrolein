    ...
    html: `
      <div style="font-family: Arial, sans-serif; color: #111; padding: 20px;">
        ...
        <div style="max-width: 600px; margin: 0 auto;">
          <h3 style="color: #222;">You've Got a New Message from an Employer</h3>

          <p style="font-size: 16px; line-height: 1.6;">
            An employer has reached out to you on <strong>Newrole.in</strong> with a message:
          </p>

          <blockquote style="background: #f9f9f9; padding: 15px; border-left: 4px solid #1A73E8; font-style: italic; color: #444;">
            ${options.text}
          </blockquote>
...
export default sendMailForMessages;
